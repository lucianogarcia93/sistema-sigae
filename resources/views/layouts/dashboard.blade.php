...
<div class="flex min-h-screen">
    ...
    <!-- SIDEBAR -->
    <aside id="sidebar"
           class="w-64 bg-blue-700 text-white p-6 space-y-6 flex-shrink-0
...
<div class="min-h-screen bg-gradient-to-br from-blue-500 via-indigo-600 to-purple-700">
    ...
    <div class="flex justify-end p-6">
        <form method="POST" action="{{ route('logout') }}">
            @csrf
            <button class="bg-red-500 hover:bg-red-600 text-white px-5 py-2 rounded-lg shadow">
                Cerrar sesión
            </button>
        </form>
    </div>
    ...
    <div class="flex justify-center pb-20">
        ...
        <div class="grid grid-cols-2 gap-8 max-w-3xl w-full">
            ...
            <a href="{{ route('alumno.asistencias.historial') }}"
               class="bg-white shadow-lg rounded-2xl p-8 text-center hover:shadow-2xl hover:scale-105 transition">
                <div class="text-5xl mb-4">📊</div>
                <h3 class="text-xl font-bold text-gray-800">Mis Asistencias</h3>
            </a>

            <a href="{{ route('alumno.feriados') }}"
               class="bg-white shadow-lg rounded-2xl p-8 text-center hover:shadow-2xl hover:scale-105 transition">
                <div class="text-5xl mb-4">📅</div>
                <h3 class="text-xl font-bold text-gray-800">Feriados del Calendario</h3>
            </a>
            ...
            <a href="{{ route('alumno.datos') }}"
               class="bg-white shadow-lg rounded-2xl p-8 text-center hover:shadow-2xl hover:scale-105 transition">
                <div class="text-5xl mb-4">👤</div>
                <h3 class="text-xl font-bold text-gray-800">Mis Datos</h3>
            </a>
            ...
            <a href="{{ route('alumno.justificacion.motivo') }}"
               class="bg-white shadow-lg rounded-2xl p-8 text-center hover:shadow-2xl hover:scale-105 transition">
                <div class="text-5xl mb-4">📝</div>
                <h3 class="text-xl font-bold text-gray-800">Justificaciones</h3>
            </a>
