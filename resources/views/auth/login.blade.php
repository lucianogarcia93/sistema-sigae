...
<body class="bg-blue-950 flex items-center justify-center min-h-screen px-4">
    ...
    <div class="w-full sm:max-w-md mx-auto px-4 sm:px-6">
        ...
        <div class="text-center mb-6 sm:mb-8">
            ...
            <p class="text-white text-sm sm:text-base mt-2 sm:mt-3 leading-snug text-center tracking-tight sm:tracking-[0.11em] uppercase">
                Sistema Integral de Gestión Académica Escolar
            </p>
        </div>

        <!-- CARD LOGIN -->
        <div class="bg-white shadow-2xl rounded-2xl p-6 sm:p-8 min-h-[70vh] sm:min-h-auto flex flex-col justify-center">
            ...
            <form method="POST" action="/login" class="space-y-4 sm:space-y-5 flex flex-col justify-center h-full">
                ...
                <div>
                    ...
                    <input 
                        ...
                        name="email" 
                        required
                        class="w-full px-3 py-3 sm:px-4 sm:py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-900 focus:outline-none transition"
                    >
                </div>
                ...
                <button 
                    type="submit"
                    class="w-full bg-blue-900 hover:bg-blue-800 text-white py-3 rounded-xl transition duration-200 font-semibold shadow-md text-base sm:text-base"
                >
                    Ingresar
                </button>
            </form>
